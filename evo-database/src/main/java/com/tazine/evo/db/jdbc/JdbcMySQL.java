package com.tazine.evo.db.jdbc;
...
public class JdbcMySQL {
    ...
    public static void main(String[] args) {
        ...
        try {
            // 1. 加载数据库驱动程序，就是加载其对 JDBC 接口的实现，通过执行静态代码块注册驱动
            Class.forName("com.mysql.jdbc.Driver");

            // 2. 建立连接
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/evo-mysql", "root", "jiaer.ly");

            // 3. 创建执行语句的 statement
            String name = "harden";
            String sql = "delete from tb_nba_player where name='" + name + "'";
            ...
            String sql1 = "insert into tb_nba_player (name,num,team ) values(?,?,?)";
            ...
            String sql2 = "SELECT * FROM tb_nba_player";
