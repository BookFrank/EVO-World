...
/**
 * GatewayDecoder01-当QPS大时会有粘包/拆包问题
 *
 * @author frank
 * @date 2019/01/09
 */
public class GatewayDecoder01 extends LengthFieldBasedFrameDecoder {
     ...
     */
    public GatewayDecoder01(int maxFrameLength, int lengthFieldOffset, int lengthFieldLength,
